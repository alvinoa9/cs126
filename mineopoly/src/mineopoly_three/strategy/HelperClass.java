...
public class HelperClass {
    ...
    /**
     * Class constructor for helper class
     * @param boardSize size of the board
     * @param maxInventorySize  size of maximum inventory
     * @param maxCharge maximum charge
     * @param winningScore  score to win
     * @param startTileLocation strating location
     * @param isRedPlayer determines if player is red
     */
