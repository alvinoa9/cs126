...
public class MineopolyMain {
    ...
    public static void main(String[] args) {
        if (TEST_STRATEGY_WIN_PERCENT) {
            MinePlayerStrategy yourStrategy = new FirstPlayerStrategy(); // TODO: Replace this with your strategy
    ...
    private static void playGameOrReplay() {
        ...
        if (savedReplayFilePath == null) {
            ...
            MinePlayerStrategy redStrategy = new FirstPlayerStrategy(); // TODO: Replace this with your strategy
    ...
    private static double getStrategyWinPercent(MinePlayerStrategy yourStrategy, int boardSize) {
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            yourStrategy.endRound(gameEngine.getRedPlayerScore(), gameEngine.getBluePlayerScore());
            randomStrategy.endRound(gameEngine.getBluePlayerScore(), gameEngine.getRedPlayerScore());
        }
