...
class LinkedList {
  ...
  private:
    ...
    /**
     * Clears the LinkedList class
     */
    void _destroy();

    /**
     * Helper method to copy class
     * @param source the linked list
     */
    void _copy(const LinkedList<ElementType>& source);
  public:
    /**
     * Helper method to print linked list to out stream
     * @param os
     */
